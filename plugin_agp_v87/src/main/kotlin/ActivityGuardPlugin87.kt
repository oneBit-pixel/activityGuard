...
class ActivityGuardPlugin87 {
     fun apply(project: Project) {
        ...
        project.plugins.withType(AppPlugin::class.java) {
            ...
            androidComponents.onVariants { variant ->
                ...
                apkTask.configure {
                    buildAapt2Input(project,it.aapt2,apkTask)
                    project.layout.buildDirectory.dir(
                        "intermediates/activityGuardApkResTask/$variantName"
                    ).also { dir ->
     ...
     * 配置aapt
     */
    private fun buildAapt2Input(
        project: Project,
        aapt2Input: Aapt2Input,
        apkTask: TaskProvider<ActivityGuardApkTask>
    ) {
        aapt2Input.initializeAapt2DaemonBuildService(apkTask.get())
        aapt2Input.initializeAapt2ThreadPoolBuildService(apkTask.get())
        val aapt2Bin =
